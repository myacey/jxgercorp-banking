...
func NewController(srv service.ServiceInterface, tokenSrv tokenpb.TokenServiceClient, lg *zap.SugaredLogger, tracer trace.Tracer, metrics telemetry.UserMetrics) *Controller {
	return &Controller{
		srv:      srv,
		lg:       lg,
		tokenSrv: tokenSrv,
